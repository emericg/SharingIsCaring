...
bool SettingsManager::readSettings()
{
    ...
    if (settings.status() == QSettings::NoError)
    {
        ...
        if (settings.contains("settings/debugMode"))
            m_debugMode = settings.value("settings/debugMode").toBool();
...
bool SettingsManager::writeSettings()
{
    ...
    if (settings.isWritable())
    {
        ...
        settings.setValue("settings/debugMode", m_debugMode);
...
void SettingsManager::setDebugMode(const bool value)
{
