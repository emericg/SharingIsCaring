...
android {
    ...
    #OTHER_FILES += $${PWD}/src/com/sharingiscaring/infos/QShareActivity.java \
    #               $${PWD}/src/com/sharingiscaring/utils/QShareUtils.java \
    #               $${PWD}/src/com/sharingiscaring/utils/QSharePathResolver.java

    # Rename these to match your project:
    #com/emeric/utils
    #com.emeric.sharingiscaring
    #com_emeric_sharingiscaring
}
